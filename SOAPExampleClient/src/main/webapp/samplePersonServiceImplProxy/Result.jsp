...
<jsp:useBean id="samplePersonServiceImplProxyid" scope="session" class="com.bhavna.service.PersonServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.bhavna.service.PersonServiceImpl getPersonServiceImpl10mtemp = samplePersonServiceImplProxyid.getPersonServiceImpl();
...
case 20:
        ...
        com.bhavna.bean.Person getPerson20mtemp = samplePersonServiceImplProxyid.getPerson(id_2idTemp);
...
case 31:
        gotMethod = true;
        com.bhavna.bean.Person[] getAllPersons31mtemp = samplePersonServiceImplProxyid.getAllPersons();
...
case 34:
        ...
        %>
        <jsp:useBean id="com1bhavna1bean1Person_3id" scope="session" class="com.bhavna.bean.Person" />
        <%
        com1bhavna1bean1Person_3id.setAge(age_4idTemp);
        com1bhavna1bean1Person_3id.setName(name_5idTemp);
        com1bhavna1bean1Person_3id.setId(id_6idTemp);
        boolean addPerson34mtemp = samplePersonServiceImplProxyid.addPerson(com1bhavna1bean1Person_3id);
